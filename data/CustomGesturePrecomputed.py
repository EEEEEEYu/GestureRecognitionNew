"""
Dataloader for precomputed Custom Gesture dataset stored in HDF5 format.
...
3. Supports train/validation modes with optional data augmentation
4. Handles different label mappings via configuration
"""
...
class CustomGesturePrecomputed(data.Dataset):
    def __init__(
        self,
        precomputed_dir: str,
        purpose: str = 'train',
        ...
        """
        Custom Gesture Precomputed Dataset Loader.
        ...
        Args:
            ...
            aug_jitter_std: Coordinate jitter standard deviation for augmentation
            aug_drop_rate: Event drop rate for augmentation
            aug_time_scale_min: Minimum temporal scaling for augmentation
            aug_time_scale_max: Maximum temporal scaling for augmentation
        ...
        with h5py.File(self.h5_path, 'r') as h5f:
            ...
            self.class_names = [cn.decode('utf-8') if isinstance(cn, bytes) else cn
                              for cn in h5f['class_names'][:]]
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        # Convert from 1-indexed (1-16) to 0-indexed (0-15) for PyTorch
...
if __name__ == '__main__':
    ...
    # Create dataset
    dataset = CustomGesturePrecomputed(
    ...
    for batch in dataloader:
        ...
        print(f"  Class names: {batch['class_names']}")
