"""
Pre-computing script for HMDB-DVS dataset using SparseVKMEncoder.

This script:
1. Loads raw events from HMDB-DVS dataset (.aedat format)
...
class HMDBPreprocessor:
    ...
    def run(self):
        ...
        print("Starting HMDB-DVS dataset preprocessing...")
...
def main():
    ...
    preprocessor = HMDBPreprocessor(config)
    preprocessor.run()
