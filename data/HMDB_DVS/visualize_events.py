"""
Self-contained visualization script for HMDB-DVS dataset.
...
from dataset import HMDB_DVS, HMDB_CLASSES
...
def main():
    parser = argparse.ArgumentParser(description='Visualize HMDB-DVS events')
    parser.add_argument(
        '--dataset_dir',
        type=str,
        default='~/Downloads/HMDB_DVS',
        help='Path to HMDB_DVS dataset'
    )
    parser.add_argument(
        '--sample_idx',
        type=int,
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default='./visualizations/hmdb_dvs',
    ...
    # Load dataset
    print(f"Loading HMDB-DVS dataset from {args.dataset_dir}...")
    dataset = HMDB_DVS(
    ...
    # Save
    output_path = output_dir / f'hmdb_dvs_sample_{args.sample_idx}_{class_name}.png'
