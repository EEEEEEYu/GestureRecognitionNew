"""
Pre-computing script for UCF101-DVS dataset using SparseVKMEncoder.
...
class UCF101Preprocessor:
    ...
    def encode_events_for_interval(
        ...
        # Some .mat files may contain out-of-bounds events due to sensor noise
        # ===================================================================
    ...
    def encode_sample(self, sample: Dict, rotation_angle: int = 0, time_scale: float = 1.0) -> Dict:
        """
        ...
        if time_scale != 1.0:
            events_xy_sliced, events_t_sliced, events_p_sliced = scale_time_sliced_events(
                events_xy_sliced,
                events_t_sliced,
                events_p_sliced,
    ...
    def preprocess_split(self, purpose: str):
        ...
        with h5py.File(h5_path, mode) as h5f:
            ...
            for idx in pbar:
                ...
                # Generate augmented versions (rotation and time scaling)
                samples_to_process = []
                ...
                for params in samples_to_process:
                    ...
                    # Encode sample with rotation and scaling
                    encoded_sample = self.encode_sample(sample, rotation_angle=rotation_angle, time_scale=time_scale)
...
def main():
    ...
    preprocessor = UCF101Preprocessor(config)
    preprocessor.run()
