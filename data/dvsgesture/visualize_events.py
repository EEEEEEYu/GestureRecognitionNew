"""
Self-contained visualization script for DVSGesture dataset.
...
from dvsgesture.dataset import DVSGesture, GESTURE_CLASSES
...
def main():
    parser = argparse.ArgumentParser(description='Visualize DVSGesture events')
    parser.add_argument(
        '--dataset_dir',
        type=str,
        default='/home/matt/DATA/DVSGesture',
        help='Path to DVSGesture dataset'
    )
    parser.add_argument(
        '--sample_idx',
        type=int,
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default='./visualizations/dvsgesture',
    ...
    # Load dataset
    print(f"Loading DVSGesture dataset from {args.dataset_dir}...")
    dataset = DVSGesture(
    ...
    label = sample['label']
    class_name = GESTURE_CLASSES[label]
    ...
    # Save
    output_path = output_dir / f'dvsgesture_sample_{args.sample_idx}_{class_name}.png'
